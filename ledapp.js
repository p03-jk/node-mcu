...
const client = mqtt.connect('possum-01.lmq.cloudamqp.com', {
  username: 'luowgrgi',
  password: 'bGBqen2MVrYasWxj8Ovb_9R3RH',
  port: 5672
});
...
app.post('/webhook', async (req, res) => {
  ...
  const TOKEN = `hj3aKv/RY7ulVNnxgB2gGpRZqbxGLFf9Ra+Gizo3V6Bp78ViZMENX9NziQG4jbIq0nCldSJV09tuzCnX2u+dT7x3RoSRn9A8zGGycJKrSEBwkQF+100NDpqlNP8Zx/U14t1lkHFwM5khYCNOQDA2jgdB04t89/1O/w1cDnyilFU=`;
  const HEADERS = {
